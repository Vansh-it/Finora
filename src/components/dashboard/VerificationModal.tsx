...
const BEGINNER_EXPLANATIONS: Record<string, string> = {
  ...
  'gross_profit': 'Revenue minus the direct cost of producing goods sold.',
  'operating_income': 'Profit from core business operations before interest and taxes.',
  'net_income': 'The bottom line — profit after all expenses, interest, and taxes are paid.',
  'operating_margin': 'What percentage of revenue becomes operating income.',
  'net_margin': 'What percentage of revenue becomes net profit.',
  ...
  'roic': 'Return on invested capital — the return generated on all capital invested.',
  'current_ratio': 'Current assets divided by current liabilities. Measures ability to pay short-term obligations.',
  'debt_to_equity': 'Total debt relative to shareholders\' equity.',
  'free_cash_flow': 'Cash generated from operations minus capital expenditures.',
  'gross_margin': 'Gross profit as a percentage of revenue.',
  'fcf_margin': 'Free cash flow as a percentage of revenue.',
  'ebitda': 'Earnings before interest, taxes, depreciation, and amortization.',
};

export default function VerificationModal({ kpi, onClose }: { kpi: KpiData | null | undefined; onClose: () => void }) {
  if (!kpi) return null;
      ...
      <div className="relative flex h-full w-full max-w-md flex-col overflow-y-auto border-l-2 border-ink bg-paper p-6 shadow-2xl sm:p-8">
        ...
        {kpi.verification && (
          <div className="mt-8 border-t border-ink/15 pt-6">
            ...
            {kpi.verification.values && kpi.verification.values.length > 0 && (
            ...
            {kpi.verification?.source && (
              <>
                <div className="font-mono text-[10px] leading-tight tracking-[0.18em] uppercase">
                  ...
                  <div className="mt-0.5 text-ink-3">{kpi.verification.source.doc || 'SEC 10-K'}</div>
                </div>
                <div className="font-mono text-[10px] leading-tight tracking-[0.18em] uppercase">
